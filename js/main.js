...
document.addEventListener("click", (e) => {
    ...
    if (e.target !== menubutton && e.target !== menuLinks) {
        if (
            menubutton.classList.contains("menu-active") &&
...
document.addEventListener("keyup", (e) => {
    if (e.key === "Escape") {
        ...
        document
            .querySelector(".links-container .toggle-menu")
...
//Fill Contact Us Background while filled

let contactInputs = document.querySelectorAll(
    ".contact-us form input:not([type='submit'])"
);
let contactMessage = document.querySelector(".contact-us form textarea");
if (contactMessage.value !== "") {
    contactInputs.style.background = "#FFF";
}

contactMessage.addEventListener("change", (e) => {
    if (contactMessage.value !== "") {
        contactMessage.style.backgroundColor = "#FFF";
    } else {
        contactMessage.style.backgroundColor = "transparent";
    }
});
...
//Toggle Menu
let menubutton = document.querySelector(".links-container .toggle-menu");
